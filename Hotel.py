...
while c=='y':
    ...
    if choice==1:
        ...
        for i in range (n):
            ...
            Type=raw_input(' Enter the type of room you want (Normal(enter A) , Suite(enter B) or Delux(enter C)) ')
        ...
        for j in l:
            ...
            if idproof in ltemp:
                ...
                print "Cost incurred: Rs.",ltemp[5]
        ...
        root.title("GOLDEN PEACOCK ORDER PORTAL")
        ...
        lblInfo = Label(Tops, font=("arial" , 50 ,"bold") ,text="Golden Peacock",fg="gold" , bd=10 , anchor = "w")
        ...
        def Ref():
            ...
            CostofFries=Cof*4.85
            CostofCola=Cocola*2.5
            CostofPav=CoP*30
            CostofChana=CoCh*80
            CostofBurger=CoBurger*56
            CostofShawarma=CoS*35
            Costofmeal="Rs.",str('%2f' % (CostofFries+CostofCola+CostofPav+CostofChana+CostofBurger+CostofShawarma))
            PayTax=((CostofFries+CostofCola+CostofPav+CostofChana+CostofBurger+CostofShawarma)*0.3)
            Totalcost=(CostofFries+CostofCola+CostofPav+CostofChana+CostofBurger+CostofShawarma)
            Ser_Charge=((CostofFries+CostofCola+CostofPav+CostofChana+CostofBurger+CostofShawarma)/99)
        ...
        lblchanabhatura = Label(f1,font=("arial" , 16,"bold"), text="Chana Bhatura" , bd=16, anchor = "w")
        lblchanabhatura.grid(row=4,column=0)
        txtchanabhatura=Entry(f1,font=("arial" , 16,"bold"), textvariable=Chana_Bhatura , bd=10, insertwidth=4,bg="powder blue", justify ="right")
        ...
        txtcost=Entry(f1,font=("arial" , 16,"bold"), textvariable=Total , bd=10, insertwidth=4,bg="powder blue", justify ="right")
